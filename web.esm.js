...
(function ($) {
    ...
    __decorate([
        $.$mol_mem
    ], $my_tele2_group.prototype, "Title", null);
    __decorate([
        $.$mol_mem
    ], $my_tele2_group.prototype, "Params", null);
    $.$my_tele2_group = $my_tele2_group;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $my_tele2_settings extends $.$mol_page {
        title() {
            return "Настрой Tele2 под себя";
        }
        head() {
            return [this.Logo(), this.Title(), this.Tools()];
        }
        Logo() {
            return ((obj) => {
                obj.uri = () => "my/tele2/logo/logo_128.png";
                return obj;
            })(new this.$.$mol_image());
        }
    }
    __decorate([
        $.$mol_mem
    ], $my_tele2_settings.prototype, "Logo", null);
    $.$my_tele2_settings = $my_tele2_settings;
})($ || ($ = {}));
(function ($) {
    class $my_tele2 extends $.$my_tele2_settings {
        ...
        Source() {
            return ((obj) => {
                obj.uri = () => "https://github.com/nin-jin/tele2";
                return obj;
        ...
        Settings() {
            return ((obj) => {
                obj.sub = () => [this.Groups(), this.Description()];
                return obj;
            })(new this.$.$mol_form());
        }
        Groups() {
        ...
        Daily() {
            return ((obj) => {
                obj.sub = () => [this.daily(), this.currency(), " в день"];
                return obj;
            })(new this.$.$mol_view());
        }
        daily() {
        ...
        Monthly() {
            return ((obj) => {
                obj.sub = () => [this.monthly(), this.currency(), " за 30 дней"];
                return obj;
            })(new this.$.$mol_view());
        }
        monthly() {
        ...
        Group(id) {
            return ((obj) => {
                ...
                obj.params = () => this.group_params(id);
                return obj;
            })(new this.$.$my_tele2_group());
        }
        group_title(id) {
            return "";
        }
        ...
        Param_switch(id) {
            return ((obj) => {
                obj.name = () => this.param_title(id);
                obj.control = () => this.Param_switch_control(id);
                return obj;
        ...
        Param_switch_control(id) {
            return ((obj) => {
                obj.value = (val) => this.param_string(id, val);
                obj.options = () => this.param_options(id);
                return obj;
            })(new this.$.$mol_switch());
        }
        param_string(id, val, force) {
            return (val !== void 0) ? val : "";
        }
        param_options(id) {
            return ({});
    ...
    __decorate([
        $.$mol_mem
    ], $my_tele2.prototype, "Source", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem
    ], $my_tele2.prototype, "Description", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem_key
    ], $my_tele2.prototype, "Param_switch", null);
    __decorate([
        $.$mol_mem_key
    ], $my_tele2.prototype, "Param_switch_control", null);
    __decorate([
        $.$mol_mem_key
...
;
var $node = $node || {} ; $node[ "/my/tele2/logo/logo_128.png" ] = "data:image/png;base64,"
...
(function ($) {
    ...
    $.$my_tele2_tarif_group = $.$mol_data_record({
        title: $.$my_tele2_tarif_locale,
        icon: $.$mol_data_string,
        param: $.$mol_data_dict($.$my_tele2_tarif_param),
    });
    $.$my_tele2_tarif_groups = $.$mol_data_dict($.$my_tele2_tarif_group);
    $.$my_tele2_tarif_scheme = $.$mol_data_record({
...
var $;
(function ($) {
    function $my_tele2_locale(all) {
        var _a;
        return (_a = all[this.$mol_locale.lang()]) !== null && _a !== void 0 ? _a : all['ru'];
    }
    $.$my_tele2_locale = $my_tele2_locale;
})($ || ($ = {}));
//locale.js.map
;
"use strict";
...
(function ($) {
    ...
    (function ($$) {
        class $my_tele2 extends $.$my_tele2 {
            ...
            param_flag(id, next) {
                var _a;
                return (_a = next !== null && next !== void 0 ? next : (this.settings_current()[id] === true)) !== null && _a !== void 0 ? _a : false;
            }
            param_value(id) {
                switch (this.param_type(id)) {
            ...
            settings_id(next) {
                var _a;
                return (_a = this.$.$mol_state_arg.value('settings', next)) !== null && _a !== void 0 ? _a : $.$mol_stub_code();
            }
            settings(id, next) {
                var _a;
                return (_a = $.$mol_shared.cache(`settings=${id}`, next)) !== null && _a !== void 0 ? _a : {};
            }
        ...
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "tarif_scheme", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "groups", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "group_title", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "params", null);
        __decorate([
            $.$mol_mem_key
        ], $my_tele2.prototype, "group_params", null);
        __decorate([
            $.$mol_mem_key
        ], $my_tele2.prototype, "Param", null);
        __decorate([
            $.$mol_mem_key
        ], $my_tele2.prototype, "param_title", null);
        __decorate([
            $.$mol_mem_key
        ...
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "settings_id", null);
        __decorate([
            $.$mol_mem_key
        ], $my_tele2.prototype, "settings", null);
        __decorate([
