...
declare namespace $ {
    ...
    let $my_tele2_tarif_groups: ((val: unknown) => Readonly<Record<string, Readonly<{
        title: {
            [x: string]: string;
        };
        icon: string;
    ...
    let $my_tele2_tarif_scheme: ((val: unknown) => Readonly<{
        description: {
            [x: string]: string;
        };
        currency: string;
        ...
        config: {
            description: ((val: unknown) => Readonly<Record<string, string>>) & {
                config: (val: string) => string;
                Value: Readonly<Record<string, string>>;
            };
            currency: (val: string) => string;
            group: ((val: unknown) => Readonly<Record<string, Readonly<{
                title: {
                    [x: string]: string;
                };
                icon: string;
...
declare namespace $ {
    ...
    class $my_tele2 extends $mol_book2 {
        ...
        param_string(id: any, val?: any): any;
        param_options(id: any): {};
        Param_switch_control(id: any): $$.$mol_switch;
        param_flag(id: any, val?: any): any;
        ...
        tarif_name(id: any): string;
        tarif_id(id: any): string;
    }
}
...
declare namespace $.$$ {
    class $my_tele2 extends $.$my_tele2 {
        ...
        settings(id: string, next?: Record<string, string | boolean>): Record<string, string | boolean>;
        settings_current(next?: Record<string, string | boolean>): Record<string, string | boolean>;
        settings_next(): Record<string, string | boolean>;
        order_enabled(): boolean;
        order(): void;
        user_id(): unknown;
        tarif_all(next?: Record<string, string>): Record<string, string>;
        tarif_current(next?: string): string;
        tarif_list(): $mol_link[];
        tarif_id(id: string): string;
        tarif_name(id: string): string;
    }
}
