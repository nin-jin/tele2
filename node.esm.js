...
(function ($) {
    class $my_tele2_settings extends $.$mol_page {
        title() {
            return this.$.$mol_locale.text("$my_tele2_settings_title");
        }
        head() {
...
(function ($) {
    class $my_tele2 extends $.$mol_book2 {
        tarif_name_default() {
            return this.$.$mol_locale.text("$my_tele2_tarif_name_default");
        }
        plugins() {
            return [this.Theme()];
        }
        ...
        pages() {
            return [this.Menu(), this.Settings()];
        }
        Menu() {
            return ((obj) => {
        ...
        menu_title() {
            return this.$.$mol_locale.text("$my_tele2_menu_title");
        }
        Tarif_list() {
            return ((obj) => {
                obj.rows = () => this.tarif_list();
                obj.Empty = () => this.Tarif_list_empty();
                return obj;
            })(new this.$.$mol_list());
        }
        tarif_list() {
        ...
        Tarif_list_empty() {
            return ((obj) => {
                obj.text = () => this.tarif_list_empty();
                return obj;
            })(new this.$.$mol_text());
        }
        tarif_list_empty() {
            return "Your tarifs will be placed here.";
        }
        Scheme_list() {
            return ((obj) => {
        ...
        Smart_link() {
            return ((obj) => {
                ...
                obj.title = () => this.smart_link_title();
                return obj;
            })(new this.$.$mol_link());
        }
        smart_link_title() {
            return this.$.$mol_locale.text("$my_tele2_smart_link_title");
        }
        Personal_link() {
            return ((obj) => {
                obj.arg = () => ({
                ...
                obj.title = () => this.personal_link_title();
                return obj;
            })(new this.$.$mol_link());
        }
        personal_link_title() {
            return this.$.$mol_locale.text("$my_tele2_personal_link_title");
        }
        Business_link() {
            return ((obj) => {
                obj.arg = () => ({
                ...
                obj.title = () => this.business_link_title();
                return obj;
            })(new this.$.$mol_link());
        }
        business_link_title() {
            return this.$.$mol_locale.text("$my_tele2_business_link_title");
        }
        Settings() {
            return ((obj) => {
                obj.tools = () => [this.Lights(), this.Source()];
                obj.body = () => [this.Groups(), this.Description()];
                obj.foot = () => [this.Daily(), this.label_or(), this.Monthly(), this.Order()];
                return obj;
            })(new this.$.$my_tele2_settings());
        }
        Lights() {
            return ((obj) => {
                return obj;
        ...
        Daily() {
            return ((obj) => {
                obj.sub = () => [this.daily(), this.currency(), this.daily_suffix()];
                return obj;
            })(new this.$.$mol_view());
        }
        daily() {
        ...
        daily_suffix() {
            return this.$.$mol_locale.text("$my_tele2_daily_suffix");
        }
        label_or() {
            return this.$.$mol_locale.text("$my_tele2_label_or");
        }
        Monthly() {
            return ((obj) => {
                obj.sub = () => [this.monthly(), this.currency(), this.monthly_suffix()];
                return obj;
            })(new this.$.$mol_view());
        }
        monthly() {
        ...
        Order() {
            return ((obj) => {
                ...
                obj.enabled = () => this.order_enabled();
        ...
        Tarif_link(id) {
            return ((obj) => {
                obj.title = () => this.tarif_name(id);
                obj.arg = () => ({
                    "tarif": this.tarif_id(id),
                });
                return obj;
            })(new this.$.$mol_link());
        }
    ...
    __decorate([
        $.$mol_mem
    ], $my_tele2.prototype, "Theme", null);
    __decorate([
        $.$mol_mem
    ], $my_tele2.prototype, "Menu", null);
    __decorate([
        $.$mol_mem
    ], $my_tele2.prototype, "Tarif_list", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem
    ], $my_tele2.prototype, "Lights", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem_key
    ], $my_tele2.prototype, "Tarif_link", null);
    $.$my_tele2 = $my_tele2;
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        class $my_tele2 extends $.$my_tele2 {
            ...
            settings_id(next) {
                ...
                if (id) {
                    ...
                    const id2 = (_a = Object.keys(all)[0]) !== null && _a !== void 0 ? _a : $.$mol_stub_code();
            ...
            settings(id, next) {
                var _a;
                return (_a = $.$mol_shared.cache(`tarif=${id}`, next)) !== null && _a !== void 0 ? _a : {};
            }
            ...
            order_enabled() {
                if (!this.tarif_all()[this.tarif_current()])
                    return true;
            ...
            tarif_all(next) {
                ...
                return (_a = $.$mol_shared.cache(uri, next ? { tarifs: next } : undefined).tarifs) !== null && _a !== void 0 ? _a : {};
            }
            tarif_current(next) {
                var _a;
                const uri = `user=${this.user_id()}/tarif/active`;
                return (_a = $.$mol_shared.cache(uri, next ? { active: next } : undefined).active) !== null && _a !== void 0 ? _a : null;
            }
            tarif_list() {
        ...
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "settings_next", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "order_enabled", null);
        __decorate([
            $.$mol_fiber.method
        ], $my_tele2.prototype, "order", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "user_id", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "tarif_all", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "tarif_current", null);
        __decorate([
            $.$mol_mem
        ], $my_tele2.prototype, "tarif_list", null);
        $$.$my_tele2 = $my_tele2;
